...
function drawLine (constraint) {
	bob1Position = constraint.bodyA.position;    
	roofObjectPosition = constraint.bodyB.position;
	roofObjectOffset = constraint.pointB;
	roofObjectX= roofObject.Position.x + roofObjectOffset.x;
	roofObjectY= roofObject.Position.y + roofObjectOffset.y; 
	line(bob1Position.x, bob1Position.y, roofObjectX, roofObjectY);           
}
